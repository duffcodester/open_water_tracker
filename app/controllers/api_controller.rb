class ApiController < ApplicationController
  ...
  def out_of_state
    ...
    @swimmers = {}
    if query
      url = "http://www.usms.org/reg/members/jqs/searchmembers.php?RegYear=2016LastName=#{query}&oper=csv&_search=false&nd=1398554078479&rows=200&page=1&sidx=BinaryLastName+asc%2C+FirstName+asc%2C+RegDate&sord=asc&totalrows=-1"
      key = 'swimmer'
