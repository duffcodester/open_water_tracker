class Swimmer < ActiveRecord::Base
  ...
  def self.user_hash
    # :nocov:
    {
      ...
      account_id: @account_id,
      email: @row['email'].to_s.squish.downcase,
      date_of_birth: Time.zone.parse(@row['date_of_birth'].to_s),
      emergency_first: @row['emergency_contact_first_name'].to_s.squish,
      emergency_last: @row['emergency_contact_last_name'].to_s.squish,
      emergency_phone: @row['emergency_contact_phone_number'].to_s.squish
    }
    # :nocov:
  end
