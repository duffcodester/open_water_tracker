...
describe Swimmer do
  ...
  #       csv << ['First Name', 'MI', 'Last Name', 'LMSC', 'Club', 'WO Group',
  #         'USMS Number', 'Reg. Date']
  #       csv << ['Robert', 'J', 'Zweben', 'CO', 'CALM', 'N/A', '3842-03HUD',
  #          '18/12/2013']
  #       csv << ['Robert', 'J', 'Zweben', 'CO', 'CALM', 'N/A', '3842-03HUD',
  #          '18/12/2013']
  #       csv << ['Daniel', nil, 'Zweers', 'PV', 'L4S', 'N/A', '104M-0842C',
  #          '01/11/2013']
